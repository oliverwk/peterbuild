...
function AddProduct(product) {
    ...
    p.className = "detail";
    p.innerText = product.description.replaceAll("<p>", "").replaceAll("</p>", "").replaceAll("<br />", "").replaceAll("<br>", "").replaceAll("&nbsp;","");
    div.appendChild(p);
